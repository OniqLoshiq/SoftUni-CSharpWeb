...
namespace SIS.HTTP.Requests
{
    public class HttpRequest : IHttpRequest
    {
        ...
        private void ParseFormDataParameters(string formData)
        {
            ...
            string[] formParams = formData.Split(new[] { '&' }, StringSplitOptions.RemoveEmptyEntries);

            foreach (var keyValuePairData in formParams)
            {
                string[] keyValuePair = keyValuePairData.Split(new[] { '=' }, StringSplitOptions.RemoveEmptyEntries);
